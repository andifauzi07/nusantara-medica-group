		...
		<div className="bg-black text-white md:py-8 pb-6 md:px-6">
			<div className="flex flex-col md:flex-row py-6 md:px-8 gap-6 md:gap-4">
				<div className="px-4 md:w-1/3 flex flex-col gap-4">
					<p className="font-bold md:text-3xl">NMA Herbal Medika</p>
				...
				<div className="px-4 md:w-1/3 flex flex-col gap-4">
					...
					<div className="text-center lg:text-left lg:block flex justify-center items-start lg:items-center flex-col">
						<span className="flex gap-4 py-2">
							...
							/>
							<p className="text-xs">BTN Bukit Tamarunang Blok L1 No.5 Gowa</p>
						</span>
						<span className="flex gap-4 py-2">
							<Image
								...
								className="w-auto h-auto"
							/>
							<p className="text-xs">+6282395209997</p>
						</span>
						<span className="flex gap-4 py-2">
							<Image
								...
								className="w-auto h-auto"
							/>
							<p className="text-xs">nmaherbalmedika@gmail.com</p>
						</span>
					</div>
				</div>
			</div>
			<p className="text-xs text-center font-light mt-4">NMA Herbal Medika 2024 All Rights Reserved</p>
		</div>
	);
}
