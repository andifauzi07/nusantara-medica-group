...
export default function Produk() {
	return (
		<div className="px-8 py-8 md:py-10 bg-[#EBEBEB]">
			...
			<div className="md:flex w-full scroll-hidden md:gap-4">
				{produkCard.map((produk) => (
					<div
						key={produk.id}
						className="flex bg-white md:p-3 md:rounded-2xl rounded-xl md:justify-center md:w-[947px] md:gap-4 mt-4 items-center">
						<Image
							src={produk.image}
							width={200}
							height={200}
							alt={produk.id}
							className="rounded-none md:h-[180px] md:w-[180px] md:rounded-xl rounded-l-xl w-24 h-24"
						/>
