	...
	return (
		<div className="bg-main rounded-tl-4xl md:rounded-none md:bg-white md:flex md:gap-x-10 md:justify-center md:px-8 md:text-black text-white py-4 relative">
			...
			<div className="md:w-1/3 px-8 py-4">
				...
				<p className="text-center justify-center md:font-base font-extralight md:text-base text-sm">Menghadirkan Kesehatan Alami dengan Kebaikan Herbal, Tanpa Efek Samping, untuk Hidup yang Lebih Seimbang dan Berkualitas.</p>
			</div>
		</div>
	);
}
